...
internal class Build : NukeBuild
{
    ...
    public readonly string GitAuthorEmail;

    [Parameter("The git author username, used for tagging release commits.")]
    public readonly string GitAuthorUsername;
    ...
    public Target TagVersion => _ => _
            ...
            .Executes(() =>
            {
                Log.Information("📌 Starting release commit tagging...");
                ...
                {
                    Log.Error("SemVer commit tagging failed: {Message}", ex.Message);
                    throw;
                }
            });
