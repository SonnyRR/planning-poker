...
class Build : NukeBuild
{
	...
	[PackageExecutable("mapster.tool", "Mapster.Tool.dll", Framework = "net6.0")]
	readonly Tool Mapster;
	...
	Target CodeGenerateModels => _ => _
		...
		.Executes(() =>
		{
			...
			this.Mapster.Invoke($"extension -a {assemblyToScan} -o {this.CoreAssemblyDirectory / "Mapping"} -n {MAPPERS_NAMESPACE}");
			this.Mapster.Invoke($"mapper -a {assemblyToScan} -o {this.CoreAssemblyDirectory / "Mapping"} -n {MAPPERS_NAMESPACE}");
