...
namespace PlanningPoker.Persistence.Migrations
{
    ...
    [Migration("20241221174600_RemoveNonDeterministicSeedData")]
    partial class RemoveNonDeterministicSeedData
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PlanningPoker.Persistence.Entities.Card", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTimeOffset(new DateTime(2024, 9, 7, 21, 22, 49, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                            UnicodeValue = "0",
                            Value = 0f
                        },
