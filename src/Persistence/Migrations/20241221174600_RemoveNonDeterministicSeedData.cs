...
{
    /// <inheritdoc />
    public partial class RemoveNonDeterministicSeedData : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.UpdateData(
                ...
                column: "CreatedOn",
                value: new DateTimeOffset(new DateTime(2024, 9, 7, 21, 22, 49, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)));
